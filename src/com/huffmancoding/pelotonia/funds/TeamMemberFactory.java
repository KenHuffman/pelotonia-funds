...
public class TeamMemberFactory
{
     ...
     */
    TeamMemberFactory(List<SpreadsheetColumn> additionalColumns)
    {
    ...
    /**
     * Return the columns necessary for creating a TeamMember
     *
     * @return the necessary and optional columns in the spreadsheet
     */
